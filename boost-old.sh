...
# Build for simulator
# XXX: wasn't able to get this to work
...
./b2 -a -j8 --prefix=$root/install-ios-sim toolset=clang-iphonesimulator binary-format=mach-o abi=aapcs link=static --with-iostreams --with-regex install
./b2 clean
